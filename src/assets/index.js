            ...
            children: [i.jsxs("div", {
                ...
                children: [i.jsxs("div", {
                    ...
                    children: [
                        ...
                        i.jsx("br", {}),
                        i.jsx("br", {}),
                        "- 改进的逻辑，使 MigFlash 的行为更加接近真实游戏卡带",
                        i.jsx("br", {}),
                        "- 改进的 MigFlash V1 逻辑",
                        i.jsx("br", {}),
                        "- 更好地支持裁剪过的 ROM 文件",
                        i.jsx("br", {}),
                        i.jsx("br", {}),
                        "我们特别感谢 TotalJustice 协助我们改进 MigFlash。",
                        i.jsx("br", {}),
                        i.jsx("br", {}),
                        "我们已建立了一个专用测试平台，用以将搭载固件 1.2.1 的 MigFlash 与多个真实游戏卡带进行对比，涵盖各种使用场景和边缘情况，以检测是否存在行为差异。",
                        i.jsx("br", {}),
                        i.jsx("br", {}),
                        "在经过严格测试后，我们未发现任何差异。我们有信心地宣布：搭载固件 1.2.1 的 MigFlash 几乎无法被识别出与真实游戏卡带的区别。",
                        i.jsx("br", {}),
                        i.jsx("br", {}),
                        "但我们并非完美，因此我们决定发起一个漏洞赏金计划，任何社区成员若能检测出 MigFlash 并帮助我们改进产品，即可获得奖励。",
                        i.jsx("br", {}),
                        "如果您认为自己能够识别出 MigFlash，请通过以下方式发送可验证的证据和详细信息：发送邮件至 contact AT migflash DOT com，或使用我们的联系表单。",
                        i.jsx("br", {}),
                        "您可以选择保持匿名，或者告诉我们您希望我们在下一次更新中引用的名字/昵称。",
                        i.jsx("br", {}),
                        "视情况严重程度和我们自行决定，我们将最多提供 1（一个）以太坊，作为感谢您代表所有 MigFlash 用户所作贡献的酬谢，转入您提供的钱包地址中。",
                        i.jsx("br", {}),
                        i.jsx("br", {}),
                        "免责声明：尽管我们相信，任何合法使用 MigFlash 的用户在根据我们的使用条款将其作为备份/便利与游戏保存设备时不会被封禁，我们无法对封禁行为提供任何保证。如发生封禁，我们不承担责任，也不会提供任何赔偿或退款，无论用户是否提供了相关证据。",
                        i.jsx("br", {}),
                        i.jsx("a", {
                            onClick: () => window.scrollTo(0, 0),
                            href: "/#/downloads",
